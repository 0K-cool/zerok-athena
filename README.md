...
|---------|-----|---------|-------|
| **External** | `kali.linux.vkloud.antsle.us:5000` | Cloud-based pentesting | 50+ tools |
| **Internal** | `172.26.80.76:5000` (ZeroTier) | On-premise pentesting | ProjectDiscovery + AD tools |
