...
AGENT_ROLES: dict[str, AgentRoleConfig] = {
    ...
    "WV": AgentRoleConfig(
        ...
        playbooks=("docs/playbooks/web-application-attacks.md",
                   "docs/playbooks/sql-injection-testing.md"),
    ...
    "EX": AgentRoleConfig(
        ...
        playbooks=("docs/playbooks/credential-attacks.md",
                   ...
                   "docs/playbooks/cve-exploit-research-workflow.md"),
    ...
    "RP": AgentRoleConfig(
        ...
        ptes_phase=7,
        max_tool_calls=250,
        max_cost_usd=45.00,  # Server limit: $15.00 × 3x
        max_turns_per_chunk=15,
...
def format_prompt(role: AgentRoleConfig, eid: str, target: str,
    ...
    if role.rag_queries and mode != "ctf":
        ...
        kb_section += (
            ...
            "a service or CVE you haven't seen before.\n"
        )
